...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.toll = await MockBEP20.deployed();
        ...
        await this.toll.transfer(bob, '2000', { from: minter });
        await this.toll.transfer(alice, '2000', { from: minter });
        await this.toll.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.toll.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.toll.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.toll.balanceOf(this.lotteryProxyAddress)).toString(), '418');
