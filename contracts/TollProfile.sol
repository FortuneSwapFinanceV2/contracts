...
// File: @fortuneswap/matrixswap-lib/contracts/token/BEP20/IBEP20.sol
...
// File: contracts/TollProfile.sol
...
*/
contract TollProfile is AccessControl, ERC721Holder {
    using Counters for Counters.Counter;
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;

    IBEP20 public tollToken;
    ...
    uint256 public numberTollToReactivate;
    uint256 public numberTollToRegister;
    uint256 public numberTollToUpdate;
    ...
    constructor(
        IBEP20 _tollToken,
        uint256 _numberTollToReactivate,
        uint256 _numberTollToRegister,
        uint256 _numberTollToUpdate
    ) public {
        tollToken = _tollToken;
        numberTollToReactivate = _numberTollToReactivate;
        numberTollToRegister = _numberTollToRegister;
        numberTollToUpdate = _numberTollToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends TOLL to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer TOLL tokens to this contract
        tollToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberTollToRegister
        );
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer TOLL token to this address
        tollToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberTollToUpdate
    ...
    /**
     * @dev Claim TOLL to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        tollToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of TOLL to register
     * Callable only by owner admins.
     */
    function updateNumberToll(
        uint256 newNumberTollToReactivate,
        uint256 _newNumberTollToRegister,
        uint256 _newNumberTollToUpdate
    ) external onlyOwner {
        numberTollToReactivate = newNumberTollToReactivate;
        numberTollToRegister = _newNumberTollToRegister;
        numberTollToUpdate = _newNumberTollToUpdate;
    }
